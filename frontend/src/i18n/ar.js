...
export default {
  ...
  se_terms: 'شروط المركز', se_terms_url: 'رابط خارجي للشروط (اختياري)',
  se_terms_hint: 'اكتبي شروط المركز هنا، وتفتحها العميلة من إقرار الموافقة قبل التسجيل والحجز. تُحفظ الأسطر كما هي.',
  se_terms_view: 'عرض صفحة الشروط',
  se_terms_url_hint: 'يُستخدم فقط إذا لم تُكتب الشروط أعلاه',
  tm_title: 'شروط المركز', tm_empty: 'لم ينشر المركز شروطه بعد.', tm_updated: 'آخر تحديث',
